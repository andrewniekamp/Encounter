    ...
    public class SqlAbilityData : IAbilityData
    {
        ...
        public void Generate()
        {
            if (!_context.Abilities.Any())
            {
                ...
                _context.Add(new Ability { Name = "Mysterious Chant", CharHeal = 3, FoeHarm = 2, ImageUrl = "/img/actions/inspiring-speech.png", CoolDownMiliSecs = 2000 });
                ...
                _context.Add(new Ability { Name = "Salty Insult", FoeHarm = 2, ImageUrl = "/img/actions/snide-remark.png", CoolDownMiliSecs = 1800 });
